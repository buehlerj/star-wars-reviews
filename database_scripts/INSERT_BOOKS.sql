...
VALUES (
    ...
    "https://m.media-amazon.com/images/I/91SxgwHMc0L._AC_UF1000,1000_QL80_.jpg",
    "0345511271",
    "6OuvDAAAQBAJ"
  ),
  (
    "Thrawn 3: Treason",
    "Seeing Eli Vanto come back as part of the Chiss Ascendancy was really fun to see! He was one of my favorite characters from the first book, so it was good to see how he had his deduction skills had improved. The story itself is very interesting to follow. And the climax truly shows Thrawn's genius.",
    "Not that many cons honestly, can't think of any at least.",
    "https://m.media-amazon.com/images/I/81CIiYjmsAL._SL1500_.jpg",
    "1984820982",
    "mx1-DwAAQBAJ"
  ),
  (
    "Master and Apprentice",
    "Obi Wan and Qui-Gon alone are enough to sell this book. Their master and apprentice dynamic is so cool. We get insight on how they both feel about being paired together, and it reflects the Phantom Menace so well. There are heavy prophecies in this book, and how they influenced Qui-Gon (and those around him) builds so much back story. The story is not really the main point of this book, it really is more about the characters. That said, the story is so incredible! The characters, environment, and political issues in Pijal were so dang interesting!",
    "There is somewhat of a B-Story in the book involving 2 characters. They're alright characters, but they are kinda sparse for the most part so you forget about them.",
    "https://m.media-amazon.com/images/I/81JCma0o8YL._SL1500_.jpg",
    "0525619372",
    "w0NkDwAAQBAJ"
  ),
  (
    "Thrawn 2: Alliances",
    "This book jumps between 2 different times and follows the same characters, which is a very unique premise.",
    "Some of the Padme scenes seem dragged out. There's a part where she just chills in a wrecked ship for a few days, and it was a little boring.",
    "https://m.media-amazon.com/images/I/81hGEktxY8L._SL1500_.jpg",
    "052548048X",
    "keA4DwAAQBAJ"
  ),
  (
    "Alphabet Squadron",
    "The scenes where the characters are jumping into their fighters and taking off were so engaging. My heart was pumping hearing Yrica Quell go through her launch procedure, gave me chills.",
    "It was a little difficult to follow since there were a few flashbacks for character building.",
    "https://m.media-amazon.com/images/I/81juP8IN9yL._SL1500_.jpg",
    "1984821989",
    "jIBxDwAAQBAJ"
  ),
  (
  ...
  (
    "Light of the Jedi",
    "This start to the High Republic blew away my expectations, and my expectations were very high. The highlight of this book are the new characters, and every one of them was unique and memorable. The base story line of the book got me invested in how it would all turn out and I found myself sitting down to read and losing track of time. Concepts like the Force and Hyperspace are explored in new and very different and exciting ways, which gives me high hopes for the future of the High Republic.",
    "You are immediately thrown into the action so it was difficult to keep track of all the new characters. The first Act is very long considering it takes place over the span of 3 hours. The second act is a little drawn out too. I'd say the biggest downfall of this book is the length.",
    "https://m.media-amazon.com/images/I/817ws4SipTL._SL1500_.jpg",
    "0593157710",
    "ebvQDwAAQBAJ"
  ),
  (
